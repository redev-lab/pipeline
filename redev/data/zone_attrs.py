...
# ★스캔 PDF — 보류(2026-06-14). OCR(CPU 느림·숫자 오인식 위험)·수동입력 둘 다 지금은 안 함.
#   디지털 추출분만 사용. 나중에 OCR 제대로 갖추거나 디지털본 재입수 시 처리. set_manual 통로는 보존.
SCAN_DEFERRED = [
    {"zone": "성북1구역", "고시번호": "2024-475", "zone_id": "11290NTC202410220003", "reason": "스캔 PDF"},
    {"zone": "불광5구역", "고시번호": "2025-163", "zone_id": "11380NTC202401260002", "reason": "스캔 PDF"},
]
